...
const TopNavBar = ({ onLogout, user, collapsed }) => {

const googleUser = JSON.parse(localStorage.getItem("googleUser"));
console.log("google Picture,...",googleUser?.picture)

  useEffect(() => {
    const dropdownElList = [].slice.call(
      document.querySelectorAll(".dropdown-toggle")
    );
    dropdownElList.map((dropdownToggleEl) => new Dropdown(dropdownToggleEl));
  }, []);
          ...
          <ul className="topbar-menu d-flex align-items-center gap-3">
            ...
            <li className="dropdown d-none d-sm-inline-block">
              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated">
                ...
                <a href="#" class="dropdown-item">
                  <img
                    src="assets/images/flags/bangla.jpg"
                    alt="user-image"
                    class="me-1"
                    height="12"
                  />
            ...
            <li className="dropdown">
              ...
              //  src={
              //           user.profile_photo_path
              //             // ? `https://api.iconicunityltd.com/${user.profile_photo_path}`
              //             ? `http://localhost:8000/${user.profile_photo_path}`
              //             :googleUser?.picture?`${googleUser.picture}`: "assets/images/users/avatar-1.jpg"
              //         }
                    alt="user-image"
                    width="60"
                    height="60"
                ...
                <span className="d-lg-flex flex-column gap-1 d-none">
                  ...
                  <h6 className="my-0 fw-normal">{user.mobile_number}</h6>
                </span>
              </a>
